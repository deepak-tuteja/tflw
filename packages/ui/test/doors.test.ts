...
const project = (files: ProjectView['files']): ProjectView => ({ root: '/p', envs: [], reportDir: './report', files, traceViewer: false, scratchPath: 'scratch.tflw', scratchIgnored: true, authorization: { envName: 'local', targets: [], apiBaseUrl: null, services: [] } });
