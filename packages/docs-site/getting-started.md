...
that URL is the page, and a copy of it is how you reach the page from another browser on the same
machine. `tflw ui` opens an empty directory too and offers to create
