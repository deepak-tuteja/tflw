...
function printUsage(): void {
  process.stdout.write(
    [
      ...
      '                                                      mechanically rewrite past checker-flagged deprecations (decision 38/45, SPEC §12 — planned);',
      '                                                      no rule emits a deprecation yet, so this reports "nothing to migrate" on every suite,',
      '                                                      today and for any suite you can write today. It never mutates source until one does',
