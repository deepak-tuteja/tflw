...
const MATCHER_CANDIDATES: readonly { readonly label: string; readonly specId: string }[] = [
  ...
  { label: 'has count at least', specId: 'has-count-at-least' },
  { label: 'has count at most', specId: 'has-count-at-most' },
  { label: 'is empty', specId: 'is-empty' },
  { label: 'is not empty', specId: 'is-empty' },
