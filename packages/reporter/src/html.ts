...
import type { AttemptResult, LogLevel, RequestTrace, ResponseTrace, RunReport, StepResult, TestResult } from '@tflw/runtime';
...
<main>
${slots.map((s) => renderTest(s, s.id === defaultActiveId, assetHrefs, logLevelThreshold)).join('\n')}
</main>
</div>
...
function renderTest(slot: TestSlot, active: boolean, assetHrefs: ReadonlyMap<string, string>, logLevelThreshold: LogLevel): string {
