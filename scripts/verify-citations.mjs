...
import { BARE, BARE_LETTER, BARE_HASH, JSON_RULES } from './citation-rules.mjs';

// Re-exported because `self-mutations.mjs` and the tests have always addressed them here.
export { BARE, BARE_LETTER, BARE_HASH, JSON_RULES };
