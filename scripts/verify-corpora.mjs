...
import { CORPORA as CHECK_COVERAGE_CORPORA } from './verify-check-coverage.mjs'
...
export const CORPORA = [...LEDGER_CORPORA, ...SCRUB_CORPORA, ...LANG_BUILD_CORPORA, ...CHECK_COVERAGE_CORPORA]
